...
<ul class="nav nav-tabs nav-fill mb-3 d-md-flex d-block" role="tablist">
	...
	{% endif %}
	<li class="nav-item">
		<a href="?mod=extra-config&plugin=xfields&action=url" class="nav-link {{ active1 }}"><i class="fa fa-random"></i>&nbsp;Гиперссылки</a>
	</li>
	<li class="nav-item">
		<a href="?mod=extra-config&plugin=xfields&action=about" class="nav-link {{ active0 }}"><i class="fa fa-exclamation-circle"></i>&nbsp;О плагине</a>
	</li>
</ul>
</div>
{{ entries }}