...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="panel-head-right">
			<button id="btn-create-group" type="button" data-toggle="modal" data-target="#groupEditorModal" data-backdrop="static" class="btn2"><i class="fa fa-plus-circle"></i> Создать группу</button>
		</div>
	</div>

	<table id="groups-list" class="table table-sm mb-0 table-center table-hover table-bordered">
		<thead>
			<tr>
